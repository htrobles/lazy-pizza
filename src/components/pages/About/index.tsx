        ...
        <div className="orangeBox">
          ...
          <div className="box-content">
            <div className="content">
              ...
              <p>
                At Lazy Pizza, we believe that pizza should be as unique as you
                are. That's why we've revolutionized the traditional pizza shop
                experience by putting the power in your hands. Say goodbye to
                fixed menus and hello to endless possibilities with our online
                pizza builder. Whether you're craving classic flavors or feeling
                adventurous, our DIY pizza platform allows you to create your
                own masterpiece, 24/7. No matter the hour, Lazy Pizza is here to
                satisfy your cravings, one personalized pie at a time. Join us
                in redefining the pizza experience, where laziness meets
                creativity!
              </p>
            </div>
          </div>
